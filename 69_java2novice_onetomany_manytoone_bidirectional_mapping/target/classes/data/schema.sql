DROP DATABASE IF EXISTS JAVA2NOVICEBIDIRECTIONALONETOMANY;
CREATE DATABASE IF NOT EXISTS JAVA2NOVICEBIDIRECTIONALONETOMANY CHARACTER SET utf8 COLLATE utf8_general_ci;

USE JAVA2NOVICEBIDIRECTIONALONETOMANY;
